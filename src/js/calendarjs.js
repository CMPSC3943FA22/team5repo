...
function calendarJs( id, options, searchOptions, startDateTime ) {
    ...
    function buildDateHeader() {
        ...
        if ( _options.showExtraToolbarButtons ) {
            ...
            if ( _options.fullScreenModeEnabled ) {
                _element_HeaderDateDisplay_FullScreenButton = buildToolbarButton( _element_HeaderDateDisplay, _options.enableFullScreenTooltipText, headerDoubleClick );
            }
        }
    ...
    function buildFullDayView() {
        ...
        if ( _options.showExtraToolbarButtons ) {
            _element_FullDayView_TodayButton = buildToolbarButton( titleBar,  _options.todayTooltipText, onToday );
    ...
    function buildListAllWeekEventsView() {
        ...
        if ( _options.showExtraToolbarButtons ) {
            ...
            buildToolbarButton( titleBar,  _options.thisWeekTooltipText, onThisWeek );
            buildToolbarButton( titleBar,  _options.refreshTooltipText, function() {
                refreshViews( true );
            } );
